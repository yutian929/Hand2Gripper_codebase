...
class HandModel:
    ...
    def __init__(self, robot_name: str) -> None:
        ...
        checkpoint_path = os.path.join(
            ...
            "../submodules/Hand2Gripper_hand2gripper/hand2gripper/release_checkpoint/hand2gripper.pt"
        )
    ...
    def add_frame_hand2gripper(self, vertices: np.ndarray, timestamp: float, hand_detected: bool, img_rgb: np.array, bbox: np.array, contact_logits: np.array, hand_side: str, kpts_3d_cf: np.ndarray, version: str = 'v1') -> None:
        ...
        pred_pair = self.hand2gripper_inference.predict(
        ...
        left_pt = vertices[pred_pair[0]]
        right_pt = vertices[pred_pair[1]]

        print(f"hand_side: {hand_side}, left_pt: {pred_pair[0]}, right_pt: {pred_pair[1]}")
        ...
        if pred_pair[0] == pred_pair[1]:  # Invalid prediction
